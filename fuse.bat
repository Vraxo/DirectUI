...
Fuse.exe "D:\Parsa Stuff\Visual Studio\DirectUI\MergedCodeForAI.txt" "D:\Parsa Stuff\Visual Studio\DirectUI\DirectUI\Source" "D:\Parsa Stuff\Visual Studio\DirectUI\Cocoshell\Source"
